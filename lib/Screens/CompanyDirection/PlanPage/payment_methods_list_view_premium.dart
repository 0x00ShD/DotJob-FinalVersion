...
class PaymentMethodsListViewPremium extends StatefulWidget {
  const PaymentMethodsListViewPremium({super.key});

  @override
  State<PaymentMethodsListViewPremium> createState() =>
      _PaymentMethodsListViewPremiumState();
}

class _PaymentMethodsListViewPremiumState
    extends State<PaymentMethodsListViewPremium> {
  int activeIndex = 0;
  ...
  Future<void> _pay() async {
    PaymobManager().getPaymentKey(4816, "EGP").then((String paymentKey) {
      launchUrl(
        Uri.parse(
