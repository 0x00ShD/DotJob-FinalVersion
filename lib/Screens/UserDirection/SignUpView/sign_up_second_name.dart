...
import 'package:untitled1/Screens/UserDirection/SignUpView/sign_up_first_name.dart';

class SignUpSecondName extends StatefulWidget {
  const SignUpSecondName({super.key});

  @override
  State<SignUpSecondName> createState() => _SignUpSecondNameState();
}

class _SignUpSecondNameState extends State<SignUpSecondName> {
