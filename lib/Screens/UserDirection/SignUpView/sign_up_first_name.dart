...
class SignUpFirstName extends StatefulWidget {
  const SignUpFirstName({super.key});

  @override
  State<SignUpFirstName> createState() => _SignUpFirstNameState();
}

class _SignUpFirstNameState extends State<SignUpFirstName> {
